    ...
    function (t, i, e) {
      ...
      b
        ...
        : x
          ...
          : g
            ? ((o = { start: 'touchstart', move: 'touchmove', end: 'touchend, touchcancel' }), (w = O))
            : (o = O),
      ...
      ;(k.prototype = new T()),
        ...
        (k.prototype.setPosition = function (t, i) {
          ...
          var s = { front: {} }
          ;(s.front = { transform: 'translate(' + e.frontPosition.x + 'px,' + e.frontPosition.y + 'px)' }),
            e.applyStyles(n),
            e.applyStyles(s),
      ...
      ;(E.prototype = new T()),
        ...
        (E.prototype.createNipple = function (t, i) {
          ...
          if (t.x && t.y) o = { x: t.x - s, y: t.y - r }
            ...
            n.zone.removeChild(d), (o = t), (t = { x: a.left + e.x, y: a.top + e.y })
          }
          var p = new P(this, {
            color: n.color,
            size: n.size,
        ...
        (E.prototype.processOnMove = function (t) {
          ...
          if (
            ...
            if (
              ...
              if (O > p) {
                ...
                ;(o.position.x += P),
                  ...
                  (o.el.style.left = o.position.x - (this.box.left + d.x) + 'px'),
                  (O = n(c, o.position))
              }
            } else (c = m), (O = y)
            ...
            ;((D = o.computeDirection(D)).angle = { radian: s(180 - w), degree: 180 - w }),
              o.trigger('move', D),
        ...
        var e = function () {
          ...
          i.collections.forEach(function (e) {
            e.forEach(function (e) {
              ;(t = e.el.getBoundingClientRect()), (e.position = { x: i.scroll.x + t.left, y: i.scroll.y + t.top })
            })
          })
        }
      ...
      ;(z.prototype = new T()),
        ...
        (z.prototype.onAny = function (t, i) {
          ...
          return (
            v(i, function (t) {
              ;(e = o.getIdentifier(t)), v(o.collections, s.bind(null, t, e)), t._found_ || o.removeIdentifier(e)
            }),
            !1
          )
        }),
