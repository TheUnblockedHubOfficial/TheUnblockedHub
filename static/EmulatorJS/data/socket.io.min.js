...
!(function (t, e) {
  ...
  var D = 'undefined' != typeof self ? self : 'undefined' != typeof window ? window : Function('return this')()
  function F(t) {
        ...
        r(i, [
          {
            ...
            value: function (t, e, n) {
              return y(s(i.prototype), 'emitReserved', this).call(this, 'error', new Y(t, e, n)), this
            },
          },
          {
            key: 'open',
  ...
  function et(t) {
    var e = t.xdomain
    try {
      if ('undefined' != typeof XMLHttpRequest && (!e || tt)) return new XMLHttpRequest()
    } catch (t) {}
    if (!e)
      try {
  ...
  var rt = null != new et({ xdomain: !1 }).responseType,
    it = (function (t) {
      ...
      function s(t) {
        ...
        return (r.supportsBinary = rt && !a), r.opts.withCredentials && (r.cookieJar = void 0), r
      }
      return (
        r(s, [
          {
          ...
          },
          {
            ...
            value: function () {
              var t = this.opts.secure ? 'https' : 'http',
                e = this.query || {}
              return (
                !1 !== this.opts.timestampRequests && (e[this.opts.timestampParam] = G()),
          ...
          },
          {
            ...
            value: function () {
              ...
              return i(t, { xd: this.xd, cookieJar: this.cookieJar }, this.opts), new ot(this.uri(), t)
            },
          },
          {
            key: 'doWrite',
  ...
  if (((ot.requestsCount = 0), (ot.requests = {}), 'undefined' != typeof document))
    if ('function' == typeof attachEvent) attachEvent('onunload', st)
    else if ('function' == typeof addEventListener) {
      addEventListener('onpagehide' in D ? 'pagehide' : 'unload', st, !1)
    }
  function st() {
    for (var t in ot.requests) ot.requests.hasOwnProperty(t) && ot.requests[t].abort()
  }
  var at =
          ...
          },
          {
            ...
            value: function () {
              var t = this.opts.secure ? 'wss' : 'ws',
                e = this.query || {}
              return (
                this.opts.timestampRequests && (e[this.opts.timestampParam] = G()),
              ...
              'function' == typeof WebTransport &&
                ...
                this.transport.ready.then(function () {
                  t.transport.createBidirectionalStream().then(function (e) {
                    ...
                    var i = t.query.sid ? '0{"sid":"'.concat(t.query.sid, '"}') : '0'
                    t.writer.write(new TextEncoder().encode(i)).then(function () {
                      return t.onOpen()
                    })
                  })
                }))
              ...
              for (
                var n = function (n) {
                    ...
                    !(function (t, e) {
                      ...
                      ;(function (t, e) {
                        return 'message' === t.type && 'string' != typeof t.data && e[0] >= 48 && e[0] <= 54
  ...
  function yt(t) {
    ...
    for (var i, o, s = pt.exec(t || ''), a = {}, c = 14; c--; ) a[dt[c]] = s[c] || ''
    return (
      -1 != n &&
        -1 != r &&
        ((a.source = e),
  ...
  var vt = (function (n) {
    ...
    function a(n) {
      ...
      return (
        ...
        (r.port =
          o.port || ('undefined' != typeof location && location.port ? location.port : r.secure ? '443' : '80')),
  ...
  var gt = 'function' == typeof ArrayBuffer,
    ...
    kt = 'function' == typeof Blob || ('undefined' != typeof Blob && '[object BlobConstructor]' === mt.call(Blob)),
    bt = 'function' == typeof File || ('undefined' != typeof File && '[object FileConstructor]' === mt.call(File))
  function wt(t) {
    return (
      (gt &&
        (t instanceof ArrayBuffer ||
  ...
  function _t(e, n) {
    ...
    if (wt(e)) return !0
    if (e.toJSON && 'function' == typeof e.toJSON && 1 === arguments.length) return _t(e.toJSON(), !0)
    for (var o in e) if (Object.prototype.hasOwnProperty.call(e, o) && _t(e[o])) return !0
    return !1
  }
  function Ot(t) {
    var e = [],
      n = t.data,
      r = t
    return (r.data = At(n, e)), (r.attachments = e.length), { packet: r, buffers: e }
  }
  function At(e, n) {
    if (!e) return e
    if (wt(e)) {
    ...
    if (Array.isArray(e)) {
      for (var i = new Array(e.length), o = 0; o < e.length; o++) i[o] = At(e[o], n)
      return i
    }
    if ('object' === t(e) && !(e instanceof Date)) {
      var s = {}
      for (var a in e) Object.prototype.hasOwnProperty.call(e, a) && (s[a] = At(e[a], n))
      return s
    }
    return e
  }
  ...
  function Rt(e, n) {
    ...
    else if ('object' === t(e)) for (var i in e) Object.prototype.hasOwnProperty.call(e, i) && (e[i] = Rt(e[i], n))
    return e
  }
  var Tt,
      ...
      r(t, [
        ...
        },
        {
          ...
          value: function (t) {
            var e = '' + t.type
            return (
              (t.type !== Tt.BINARY_EVENT && t.type !== Tt.BINARY_ACK) || (e += t.attachments + '-'),
              t.nsp && '/' !== t.nsp && (e += t.nsp + ','),
              null != t.id && (e += t.id),
                ...
                if ('string' == typeof t) {
                  ...
                  n || e.type === Tt.BINARY_ACK
                    ? ((e.type = n ? Tt.EVENT : Tt.ACK),
                      ...
                      0 === e.attachments && y(s(i.prototype), 'emitReserved', this).call(this, 'decoded', e))
                    : y(s(i.prototype), 'emitReserved', this).call(this, 'decoded', e)
                } else {
                  if (!wt(t) && !t.base64) throw new Error('Unknown type: ' + t)
                  if (!this.reconstructor) throw new Error('got binary data when not reconstructing a packet')
                  ;(e = this.reconstructor.takeBinaryData(t)) &&
                    ((this.reconstructor = null), y(s(i.prototype), 'emitReserved', this).call(this, 'decoded', e))
                }
              },
            },
            {
              ...
              value: function (t) {
                ...
                if (void 0 === Tt[n.type]) throw new Error('unknown packet type ' + n.type)
              ...
              value: function (t, e) {
                switch (t) {
                  ...
                  case Tt.BINARY_EVENT:
                    return (
                      Array.isArray(e) &&
                      ('number' == typeof e[0] || ('string' == typeof e[0] && -1 === Ct.indexOf(e[0])))
                    )
                  case Tt.ACK:
                  case Tt.BINARY_ACK:
        ...
        r(a, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                c || (this.connected ? (this.notifyOutgoingListeners(i), this.packet(i)) : this.sendBuffer.push(i)),
                (this.flags = {}),
                this
              )
            },
        ...
        r(s, [
          ...
          },
          {
            ...
            value: function (t, e) {
              var n = this.nsps[t]
              return (
                n ? this._autoConnect && !n.active && n.connect() : ((n = new qt(this, t, e)), (this.nsps[t] = n)), n
              )
            },
          },
          {
                ...
                var r = this.setTimeoutFn(function () {
                  e.skipReconnect ||
                    ...
                    e.skipReconnect ||
                      e.open(function (n) {
                        n
                          ? ((e._reconnecting = !1), e.reconnect(), t.emitReserved('reconnect_error', n))
                          : e.onreconnect()
                      }))
                }, n)
